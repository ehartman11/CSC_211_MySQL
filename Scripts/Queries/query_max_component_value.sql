...
SELECT company_info.comp_ticker, financial_statement.fs_id, financial_component.component_name, max(component_value.val), denomination.denom
FROM company_info
...
WHERE financial_component.component_name = "net income" and component_value.denom_id = 1;
